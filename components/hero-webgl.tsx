...
export const Hero3DWebGL = () => {
  ...
  const subtitle = "See cinema through the social lens — threads, sentiment, and trends in real time."
  ...
  return (
    <div className="h-svh bg-background relative overflow-hidden">
      ...
      <div className="h-svh uppercase items-center w-full absolute z-60 pointer-events-none px-10 flex justify-center flex-col">
        ...
        <div className="text-xs md:text-xl xl:text-2xl 2xl:text-3xl mt-2 overflow-hidden text-foreground font-bold max-w-4xl mx-auto text-center px-4">
          <div
      ...
      <div className="absolute inset-x-0 bottom-16 z-[70] flex justify-center pointer-events-none">
        <div className="pointer-events-auto">
          <a href="#how-it-works" aria-label="Get started with CineLenz">
            <button className="px-6 py-3 rounded-md bg-primary hover:bg-primary/90 text-primary-foreground font-geist transition-colors duration-200">
              Get Started
            </button>
          </a>
        </div>
